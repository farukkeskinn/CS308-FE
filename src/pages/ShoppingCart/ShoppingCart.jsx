...
export default function ShoppingCart() {
  ...
  const increaseQuantity = async (index, newQuantity) => {
    ...
    if (jwtToken && customerId) {
      try {
        ...
        await fetch(`${process.env.REACT_APP_API_BASE_URL}/api/cart-management/add-item`, {
          method: "POST",
          headers: {
  ...
  const decreaseQuantity = async (index, newQuantity) => {
    ...
    if (jwtToken && customerId && item.shoppingCartItemId) {
      try {
        await fetch(`${process.env.REACT_APP_API_BASE_URL}/api/cart-management/remove-item-quantity`, {
          method: "PATCH",
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${jwtToken}`,
  ...
  const removeItemFromCart = async (index) => {
    ...
    if (jwtToken && customerId && removedItem?.shoppingCartItemId) {
      try {
        await fetch(`${process.env.REACT_APP_API_BASE_URL}/api/cart-management/remove-item/${removedItem.shoppingCartItemId}`, {
          method: "DELETE",
          headers: {
            Authorization: `Bearer ${jwtToken}`,
          },
